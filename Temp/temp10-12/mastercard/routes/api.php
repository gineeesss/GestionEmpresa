...
//obtenerMovimientosCuentaConUnMinimo
    Route::get("cuentas/{cuenta}/movimientos/", [MovimientoController::class, "movimientosCantidadMinima"]);
    Route::post("cuentas/{cuenta}", [ClienteController::class, "destroy"]);
});
